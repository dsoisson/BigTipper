...
//This function has no parameters and returns an array of dictionaries
...
public func getMathStudents(students: Students) -> Class {
    ...
    math.insert(students[8]["name"]!) //why "name"? are the element numbers randomly picked?
...
public func getHistoryStudents(students: Students) -> Class {
    ...
    history.insert(students[7]["name"]!) //why is this an optional if it is a specific name with specific index?
